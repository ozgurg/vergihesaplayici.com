            ...
            it(`should correctly calculate phone tax if params are: price: [500, 1500, 5000] / calculateFromTaxAddedPrice: ${false}`, () => {
                calculate({
                    ...
                    prices: [
                        {
                            price: 500,
                            expected: { taxFree: 500, taxAdded: 20520 }
                        },
                        {
                            price: 1500,
                            expected: { taxFree: 1500, taxAdded: 21520 }
                        },
                        {
                            price: 5000,
                            expected: { taxFree: 5000, taxAdded: 25020 }
                        }
                    ]
                });
            });
            ...
            it(`should correctly calculate phone tax if params are: price: [500, 1500, 5000] / calculateFromTaxAddedPrice: ${true}`, () => {
                calculate({
                    ...
                    prices: [
                        {
                            price: 500,
                            expected: { taxFree: -19520, taxAdded: 500 }
                        },
                        {
                            price: 1500,
                            expected: { taxFree: -18520, taxAdded: 1500 }
                        },
                        {
                            price: 5000,
                            expected: { taxFree: -15020, taxAdded: 5000 }
                        }
                    ]
                });
            });
