    ...
    data: () => ({
        ...
        ui: {
            presets: [
                ...
                { id: 3, title: "iPhone 14 Max (128GB)", form: { price: 899, currency: "USD" } },
                { id: 4, title: "iPhone 14 Pro (128GB)", form: { price: 1099, currency: "USD" } },
                { id: 5, title: "iPhone 14 Pro Max (1TB)", form: { price: 1699, currency: "USD" } }
            ],
            registration: [
