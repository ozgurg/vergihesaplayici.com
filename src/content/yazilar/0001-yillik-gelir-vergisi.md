...
Aşağıdaki gelir türlerinden belirli sınırların üzerinde kazanç elde eden kişiler beyanname verir:

- Ticari kazanç sahipleri
- Serbest meslek erbabı (örneğin avukat, doktor, yazılımcı, mimar)
- Zirai kazanç sahipleri
- Gayrimenkul sermaye iradı (örneğin kira gelirleri)
- Menkul sermaye iradı (örneğin faiz, temettü)
- Diğer kazanç ve iratlar (örneğin arsa satışı kazancı)
...
## Gelir Türleri ve Kapsamı

Gelir Vergisi Kanunu'na göre gelir 7 ana başlığa ayrılır:

1. Ticari kazançlar
2. Zirai kazançlar
3. Ücretler
4. Serbest meslek kazançları
5. Gayrimenkul sermaye iratları (kira gelirleri)
...
> **Not:** Bu oranlar, 2025 yılı için geçerli olup ilerleyen yıllarda yeniden değerleme oranına göre artabilir.

---

## Gelir Vergisi Nasıl Hesaplanır?

Yıllık Gelir Vergisi hesaplamasında izlenecek adımlar:

### 1. Toplam Gelirin Hesaplanması

Bir takvim yılı içinde elde edilen tüm gelir türleri toplanır.
Örneğin:
...
Gelir, kademeli dilimlere göre vergilendirilir:
...
Eğer yıl içinde maaş, stopaj veya geçici vergi ödemesi yapıldıysa, bu tutarlar hesaplanan gelir vergisinden düşülür.
...
## Yıllık Gelir Vergisi Ödemesi Nasıl Yapılır?

Ödemeler şu kanallardan yapılabilir:

- **İnteraktif Vergi Dairesi**
- **Anlaşmalı bankalar** (internet veya mobil bankacılık üzerinden)
- **Vergi daireleri vezneleri**

Vergi iki eşit taksit halinde ödenir:
...
- **Kira geliri istisnası:** 2025 için 33.000 TL'ye kadar
- **Serbest meslek kazancı istisnası:** Genç girişimci istisnası (29 yaş altı) – 3 yıl boyunca 230.000 TL'ye kadar
- **Yurt dışı kazanç istisnası:** Belirli koşullarda yabancı kazançlar vergiden muaf olabilir

### Başlıca İndirimler

- Eğitim ve sağlık harcamaları (%10 sınırına kadar)
- Hayat sigortası primleri
- Bağış ve yardımlar
- Sponsorluk giderleri

Bu indirimler, beyannamede "indirilecek giderler" kısmında belirtilir.
...
| 0–110.000        | 110.000    | %15  | 16.500         |
| 110.001–230.000  | 120.000    | %20  | 24.000         |
| 230.001–580.000  | 340.000    | %27  | 91.800         |
...
- Kira gelirinde istisnayı uygulamayı unutmak
- Beyannameyi zamanında vermemek
- Stopajlı gelirleri yanlışlıkla tekrar beyan etmek
...
## Yıllık Gelir Vergisi ile Geçici Vergi Arasındaki Fark

| Özellik | Yıllık Gelir Vergisi | Geçici Vergi                 |
|---------|----------------------|------------------------------|
| Dönem   | Yıl sonu             | 3 ayda bir                   |
| Amaç    | Nihai vergi          | Avans niteliğinde            |
| Beyan   | Mart ayında          | Şubat, Mayıs, Ağustos, Kasım |
| Mahsup  | Geçici vergi düşülür | Nihai vergiye mahsup edilir  |
